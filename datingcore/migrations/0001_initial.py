    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'MALE'), (1, 'FEMALE'), (2, 'NOT_SELECTED')], default=2, null=True)),
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='datingcore.CategoryOFUSER'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='city',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='datingcore.CityOFUSER'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
